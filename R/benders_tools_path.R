...
#' 
#' 
update_weekly_cuts_path <- function(current_it,studies, simulated_year, candidates, output_area_w, output_link_w, output_link_h, inv_cost, tmp_folder, benders_options)
{
